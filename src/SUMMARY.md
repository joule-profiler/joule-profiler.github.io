...
- [Intel RAPL](sources/rapl/introduction.md)
    - [Powercap Backend](sources/rapl/powercap.md)
...
- [Core Module](architecture/core-module.md)
- [CLI Module](architecture/cli-module.md)
- [Sources Workspace](architecture/sources-workspace.md)
