...
The [Joule Profiler repository](https://github.com/joule-profiler/joule-profiler) contains complete working examples:
...
- [Phases Detection](phases-detection.md)
- [Listing Sensors](listing-sensors.md)
- [Outputs](outputs/outputs.md)
- [Use the Library](library.md)
- [Source Implementation](source-implementation.md)